...
- `playbooks/maintenance/k3s-os-upgrade.yml`: controlled Ubuntu package upgrade;
  see [the OS upgrade procedure](../docs/k3s-os-upgrade.md).
...
- `playbooks/power/k3s-power-on.yml`: validates inventory, temporarily activates
  ...
  scheduling.
- `playbooks/power/k3s-ufw.yml`: configures UFW from private inventory; see
  [requirements](../docs/k3s-ufw.md).
